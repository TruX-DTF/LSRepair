package code.parser.jdt.tree.hash;

import static code.parser.jdt.tree.hash.HashUtils.BASE;
import static code.parser.jdt.tree.hash.HashUtils.fpow;
import static code.parser.jdt.tree.hash.HashUtils.md5;

import java.util.HashMap;
import java.util.Map;

import code.parser.jdt.tree.ITree;
import code.parser.jdt.tree.hash.HashUtils;
