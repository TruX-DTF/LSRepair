package java.code.parser.jdt.tree.hash;

import static java.code.parser.jdt.tree.hash.HashUtils.BASE;
import static java.code.parser.jdt.tree.hash.HashUtils.fpow;
import static java.code.parser.jdt.tree.hash.HashUtils.md5;

import java.code.parser.jdt.tree.ITree;
import java.code.parser.jdt.tree.hash.HashUtils;
